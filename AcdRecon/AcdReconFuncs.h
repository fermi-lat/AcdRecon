...
namespace AcdRecon {
  ...
  void errorAtXPlane(double delta, const Event::TkrTrackParams& track, HepMatrix& covAtPlane);
  
  void errorAtYPlane(double delta, const Event::TkrTrackParams& track, HepMatrix& covAtPlane);
  
  void errorAtZPlane(double delta, const Event::TkrTrackParams& track, HepMatrix& covAtPlane);
